   ...
   $('#example tbody').on( 'click', 'tr', function () {
	...
	$('#kotak-dialog .close').click(function() {
        ...
        $("#save").click(function(){
         ...
         RefreshTable("#example","master/jumlah/json.jsp"); 
                    }
  ...
  $("#new").click(function(){
      $("#editData").attr("disabled","disabled");
         $("#remove").attr("disabled","disabled");
            ...
            $("#edit").hide();
            $("#delete").hide();
            $("#judul").html("Tambah Satuan Detail Jumlah Barang");  
            $("#id").val("");
            $("#kode").val("");
            $("#sb").val("");
            $("#sk").val("");
   ...
   $("#editData").click(function(){
       ...
       $("#edit").show();
       $("#delete").hide();
       $("#judul").html("Edit Satuan Detail Jumlah Barang");        
       $("#id").val(id);
...
<h5 id="_default">Master Data Detail Jumlah</h5>

<button class="open-dialog" id="new">Tambah Baru</button>&nbsp;<button class="open-dialog" id="editData">Ubah Pilihan</button>&nbsp;<button class="btn-close" id="remove">Hapus Pilihan</button>
<div class="example">
