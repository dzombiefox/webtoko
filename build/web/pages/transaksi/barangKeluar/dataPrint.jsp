...
<%@page import="config.connect"%>
  <%
        ...
        String q="select * from keluar where keluar_kode='"+kode+"'";
...
out.print(dateFormat.format(date));
    ...
    %></td>
      ...
      <%
      String detail="select detail.*,barang.barang_nama,satuan.satuan_nama from detail  join barang on detail.barang_id=barang.barang_id join satuan on detail.satuan_id=satuan.satuan_id where detail.keluar_kode='"+kode+"'";
      ...
      <td><%=barang %></td>
       ...
       <td align="right"><% out.print(kharga); %>&nbsp;&nbsp;&nbsp;=</td>
        <td align="right"><% out.print(ktot); %></td>
      </tr>
     <% }
      ...
      <tr>
        ...
        <tr>
            ...
            <td>Potongan</td>
            <td>:</td>
            <td align="right"><% out.print(ptotal);%></td>
        </tr>
        <tr>
            <td></td>
            <td>Bayar</td>
            <td>:</td>
            <td align="right"><% out.print(pbayar);%></td>
        </tr>
         <tr>
            <td></td>
            <td>Kembali</td>
            <td>:</td>
            <td align="right"><%out.print(pkembali);%></td>
        </tr>
          <tr>
           <td colspan="4" style="text-align: center">------------------------------------------------------------------------------------</td>
        </tr>
         <tr>
             <td colspan="4" align="center"><br><p>Terima Kasih atas kunjungan anda</p></td>          
        </tr>
