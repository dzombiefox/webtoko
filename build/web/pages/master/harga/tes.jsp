...
<script type="text/javascript">
    ...
    $(document).ready(function(){
          var items="";
   $.getJSON("master/harga/jtes.jsp",function(data){
      ...
      $('#example tbody').on( 'click', 'tr', function () {
		...
		if ( $(this).hasClass('selected') ) {
			...
			table.$('tr.selected').removeClass('selected');                      
                        ...
                        alert(kode);
                        $('td', this).eq(1).html("<input type='text' id='txtNome' value='"+kode+"'/>");
                        $('td', this).eq(2).html("<select id='pilihan'><% connect c=new connect();
                        
                         //String qu="select * from barang";
                        //ResultSet rst=c.GetData(qu);
                        //while(rst.next()){
                     //  out.print("<option>"+rst.getString("barang_nama")+"</option>");
                      //  }
...
<h5 id="_default">Master Data Harga</h5>
